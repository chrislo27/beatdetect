...
public class FFT extends FourierTransform
{
    ...
    public void scaleBand(int i, float s)
    {
        if (s < 0)
        {
            throw new IllegalStateException("Can't scale a frequency band by a negative value.");
        }
    ...
    public void setBand(int i, float a)
    {
        if (a < 0)
        {
            throw new IllegalStateException("Can't set a frequency band to a negative value.");
        }
    ...
    public void forward(float[] buffer)
    {
        ...
        {
            throw new IllegalStateException("FFT.forward: The length of the passed sample buffer must be equal to timeSize().");
        }
        doWindow(buffer);
    ...
    public void forward(float[] buffer, int startAt)
    {
        ...
        {
            throw new IllegalStateException( "FourierTransform.forward: not enough samples in the buffer between " +
    ...
    public void forward(float[] buffReal, float[] buffImag)
    {
        ...
        {
            throw new IllegalStateException("FFT.forward: The length of the passed buffers must be equal to timeSize().");
        }
    ...
    public void inverse(float[] buffer)
    {
        ...
        {
            throw new IllegalStateException("FFT.inverse: the passed array's length must equal FFT.timeSize().");
        }
        // conjugate

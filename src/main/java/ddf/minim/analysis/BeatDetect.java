...
public class BeatDetect
{
	...
	public void detectMode(int algo)
	{
		if (algo < 0 || algo > 1)
		{
			System.err.println("Unrecognized detect mode, defaulting to SOUND_ENERGY.");
			algo = SOUND_ENERGY;
		}
	...
	public void setSensitivity(int millis)
	{
		if (millis < 0)
		{
			System.err.println("BeatDetect: sensitivity cannot be less than zero. Defaulting to 10.");
			sensitivity = 10;
		}
		else
		{

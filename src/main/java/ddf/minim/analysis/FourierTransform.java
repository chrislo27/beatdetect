...
public abstract class FourierTransform
{
  ...
  protected void setComplex(float[] r, float[] i)
  {
    ...
    {
      throw new IllegalStateException("FourierTransform.setComplex: the two arrays must be the same length as their member counterparts.");
    }
    else
    {
  ...
  public void linAverages(int numAvg)
  {
    ...
    {
      throw new IllegalStateException("The number of averages for this transform can be at most "
          + spectrum.length / 2 + ".");
    }
    else
    {
